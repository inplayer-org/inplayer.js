...
export interface GetAccessFees extends CommonError {}
...
export interface PatchAccessFee extends CommonError {}

export interface PatchAccessFee extends AdvanceError {}
...
export interface GetCustomerAccessListGranted extends GetCustomerAccessListRevoked {}
